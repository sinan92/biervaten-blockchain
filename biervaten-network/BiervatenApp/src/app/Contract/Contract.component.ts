...
export class ContractComponent implements OnInit {
  ...
  addAsset(form: any): Promise<any> {
    this.asset = {
      $class: 'org.acme.biervaten.Contract',
      'contractId': this.contractId.value,
      'brewery': this.brewery.value,
      'cafe': this.cafe.value,
  ...
  getForm(id: any): Promise<any> {
    ...
    .then((result) => {
      ...
      if (result.brewery) {
        formObject.brewery = result.brewery;
      } else {
        formObject.brewery = null;
      }

      if (result.cafe) {
        formObject.cafe = result.cafe;
      } else {
        formObject.cafe = null;
      }
