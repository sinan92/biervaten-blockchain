...
export class ShipmentComponent implements OnInit {
  ...
  addAsset(form: any): Promise<any> {
    this.asset = {
      $class: 'org.acme.biervaten.Shipment',
      'shipmentId': this.shipmentId.value,
      'bought': this.bought.value,
      'sold': this.sold.value,
      'notificationDate': this.notificationDate.value,
  ...
  getForm(id: any): Promise<any> {
    ...
    .then((result) => {
      ...
      if (result.bought) {
        this.bought = { value: result.bought };
      } else {
        formObject.bought = null;
      }

      if (result.sold) {
        this.sold = { value: result.sold };
      } else {
        formObject.sold = null;
      }

      if (result.notificationDate) {
        formObject.notificationDate = result.notificationDate;
      } else {
        formObject.notificationDate = null;
      }
